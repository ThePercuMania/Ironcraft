...
public class GuiInventory extends GuiContainer
{
    ...
    public void initGui()
    {
        ...
        btn_GuiTuto = new GuiButton(10, 175, 18, 87, 20, "NomDeMonBouton");
        controlList.add(btn_GuiTuto);
    ...
    protected void drawGuiContainerForegroundLayer()
    {
    	...
    	fontRenderer.drawString("Level", 97, 26, 0x404040);
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        char c = '\266';
        int w = (int)(((float)EntityPlayer.Alignement * (float)(34/91)) / 2);
        
        drawTexturedModalRect(j + 84, k + 76 - w, 100, 100, 1 , 5);
        drawTexturedModalRect(j + 85, k + 77 - w, 100, 100, 1 , 3);
        drawTexturedModalRect(j + 86, k + 77 - w, 100, 100, 1 , 3);
        drawTexturedModalRect(j + 87, k + 78 - w, 100, 100, 1 , 1);
        
        drawTexturedModalRect(j + 92, k + 78 - w / 2, 100, 100, 1 , 1);
        drawTexturedModalRect(j + 93, k + 77 - w / 2, 100, 100, 1 , 3);
        drawTexturedModalRect(j + 94, k + 77 - w / 2, 100, 100, 1 , 3);
        drawTexturedModalRect(j + 95, k + 76 - w / 2, 100, 100, 1 , 5);
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
           mc.thePlayer.sendChatMessage((new StringBuilder()).append("/gamemode ").append(mc.thePlayer.username).append(" 1").toString());
        }  
    }
