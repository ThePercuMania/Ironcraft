...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(multiplayerButton = new GuiButton(2, width / 2 - 100, i + 24, 98, 20, stringtranslate.translateKey("menu.multiplayer")));
        controlList.add(new GuiButton(3, width / 2 - 100, i + 48, stringtranslate.translateKey("menu.mods")));
        controlList.add(new GuiButton(6, width / 2 + 2, i + 24, 98, 20, stringtranslate.translateKey("Mon serveur")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
        	mc.displayGuiScreen(new GuiConnecting(mc, "77.111.255.692", 25565));
        }
    }
