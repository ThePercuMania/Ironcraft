...
public class ComponentVillageTorch extends ComponentVillage
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        placeBlockAtCurrentPosition(par1World, Block.glowStone.blockID, 15, 1, 3, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.trapdoor.blockID, 4, 0, 3, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.trapdoor.blockID, 15, 1, 3, 1, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.trapdoor.blockID, 5, 2, 3, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.trapdoor.blockID, 6, 1, 3, -1, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, Block.trapdoor.blockID, 10, 1, 4, 0, par3StructureBoundingBox);
        return true;
    }
}
