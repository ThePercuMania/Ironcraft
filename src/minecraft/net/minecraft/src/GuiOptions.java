...
public class GuiOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        controlList.add(new GuiButton(201, width / 2 - 100, height / 6 + 198, stringtranslate.translateKey("Pannel Multijoueur")));
    }
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        ...
        {
        	mc.displayGuiScreen(new GuiInfo(ModLoader.getMinecraftInstance().thePlayer));
        }
