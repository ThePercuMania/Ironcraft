...
{
	/** Alignement du joueur */
	public static int Alignement = 91;
	
	/**Couleur de l'alignement*/
	public int CouleurAlignement;
    ...
    {
    	if (Alignement <= 94 && Alignement >= 88)
    		return 0x727675;
    	else if (Alignement < 88)
    		return 0xB70000;
    	else if (Alignement > 94)
    		return 0x02E0D8;
    	else
    		return 0;
    }
